...
public class AuthService(JobPlatformContext context, IConfiguration configuration, HttpClient httpClient) : IAuthService
{
    ...
    {
        if (dto is null || string.IsNullOrEmpty(dto.Provider) || string.IsNullOrEmpty(dto.Token))
